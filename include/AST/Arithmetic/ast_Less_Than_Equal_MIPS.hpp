#ifndef ast_Less_Than_Equal_MIPS_hpp
#define ast_Less_Than_Equal_MIPS_hpp
#include <string>
#include <iostream>
...
class Less_Than_Equal_MIPS
    : public Arithmetic_MIPS
{

public:
    Less_Than_Equal_MIPS(NodePtr leftinput, NodePtr rightinput);
